...
(put 'convenience 'custom-loads '(autoinsert autorevert bs completion cua-base cus-edit dabbrev display-line-numbers emacs-lock ffap filecache filesets follow hippie-exp hl-line ibuffer ido imenu kmacro linum org-protocol repeat reveal ruler-mode speedbar vcursor whitespace windmove))
...
(put 'display 'custom-loads '(display-line-numbers face-remap))
...
(put 'games 'custom-loads '(5x5 animate bubbles cookie1 decipher dunnet fortune gametree gomoku handwrite hanoi mpuz pong solitaire spook tetris))
...
(put 'mouse 'custom-loads '(artist avoid goto-addr msb strokes))
...
(put 'org 'custom-loads '(ob-core org org-attach org-capture org-crypt org-entities org-feed org-footnote org-id org-indent org-mobile org-mouse org-protocol ox))
(put 'org-agenda 'custom-loads '(org org-agenda org-duration))
...
(put 'org-babel 'custom-loads '(ob-C ob-J ob-R ob-clojure ob-core ob-ditaa ob-exp ob-gnuplot ob-groovy ob-java ob-js ob-latex ob-lilypond ob-lisp ob-lua ob-maxima ob-ocaml ob-picolisp ob-plantuml ob-python ob-ruby ob-scheme ob-shell ob-stan ob-tangle ob-vala org org-src))
...
(defvar custom-versions-load-alist '(("19.29" time-stamp) ("20" ebnf2ps ps-print) ("20.1" time-stamp) ("20.3" avoid which-func xscheme ffap add-log compile rmail uce hexl vcursor browse-url dabbrev cus-edit paren msb find-func sendmail debug diary-lib) ("20.3.3" dos-vars) ("20.4" sh-script hilit-chg compile) ("20.8" sql) ("21.1" dabbrev rmailedit latin1-disp ezimage smtpmail gnus-start hideshow strokes sb-image vc-sccs net-utils browse-url debug fortran cperl-mode cal-hebrew sgml-mode server gnus-group vc-cvs vc rmail gnus-sum sendmail gnus-agent cus-edit paren find-func vc-rcs nnmail add-log ps-print etags flyspell gnus-art ange-ftp wid-edit message) ("21.3" gnus-agent ange-ftp sql) ("22" ps-print ebnf2ps) ("22.1" allout imenu binhex tcl imap sh-script gnus-srvr spam sgml-mode mail-source gnus-int dabbrev mm-view locate fortran glasses sql gnus-win view vc-svn mm-uu descr-text ielm ffap vc gnus-score diary-lib rmail gnus-group mml2015 ispell make-mode gnus-msg shadowfile bookmark uudecode mm-util cal-tex compare-w mml find-func tls autorevert mml-sec add-log info hl-line dired org-faces smime flow-fill mail-extr ange-ftp desktop starttls diff-mode mm-url pop3 time cal-dst sendmail gnus-fun comint mm-decode grep gnus-agent latin1-disp vc-cvs nnmail gnus-delay warnings gnus-cite gnus-art server deuglify gdb-mi cus-edit hi-lock tex-mode gnus-sum compile message keypad gnus gnus-util calendar gnus-start) ("22.2" sql gdb-mi tls vc-mtn gnus-sum css-mode bibtex-style dired desktop vc-hg find-dired mail-source) ("22.3" message) ("23.1" descr-text fortune gdb-mi smiley server imap nnmail gnus-draft gnus-util gnus-dired copyright cus-edit mm-decode mml checkdoc dired-aux smime rmailmm gnus-bookmark view vc-git misearch pcmpl-unix info f90 compile gnus-msg filesets rmail gnus gnus-group informat allout spam-report vc-cvs vc-mtn gnus-score bibtex sendmail mm-uu tls hideif face-remap fortran ffap holidays message gnus-art gnus-sum time browse-url tex-mode nnmairix vc-hg pop3 woman calendar) ("23.2" diary-lib tramp-gvfs rmailmm gnus-sum help-fns ansi-color bytecomp gnus-group mm-encode rmail calendar lunar dired elint message comint auth-source desktop doc-view gdb-mi) ("23.3" desktop rmailsum calendar rmail diary-lib) ("23.4" ede) ("24.1" em-ls esh-cmd package-x esh-io ob-exp org-src cc-vars em-smart esh-proc em-prompt ob-R ob-picolisp esh-arg ob-plantuml org-crypt vc-cvs em-term log-edit em-hist erc-button copyright f90 erc-backend esh-mode em-cmpl woman etags dirtrack em-pred gnus-msg ob-lisp org-attach em-unix dired-x cc-fonts em-banner hl-line man ibuffer cus-theme esh-ext sieve-manage em-script gnus-registry gnus-srvr ido auth-source battery emacs-lock gssapi netrc gnus-art ange-ftp find-dired doc-view smtpmail em-dirs mm-decode flyspell mml vc-svn js org-mobile calendar vc-bzr gnus-group vc-rcs em-alias erc-join gnus-picon elec-pair glasses message em-rebind esh-var mml2015 shr vc gnus-html ob-tangle diary-lib calc org-habit saveplace compile org-capture url-cache image-mode ses esh-util allout gnus-sum org-ctags sendmail pcmpl-unix tramp org-entities org-clock info org-inlinetask arc-mode url-queue nnir ob-ditaa ob-core sql appt vc-sccs server ox-icalendar rcirc cl-indent gnus-async rmail smiley package cc-guess gnus-util org-archive browse-url org-table em-glob gnus cus-edit allout-widgets ob-js gnus-gravatar org-faces bibtex vc-git ox-odt gnus-int org-agenda pop3 org-list verilog-mode prolog org gnus-start feedmail mm-view org-bibtex rst) ("24.2" which-func) ("24.3" ediff-wind perl-mode em-term proced ffap org-id rcirc message erc-backend ido calendar server tramp ox-odt avoid which-func wdired bug-reference calc pcmpl-gnu pcmpl-rpm icalendar gnus-picon ob-C ob-groovy sh-script org-capture cal-html vhdl-mode hexl diff-mode ob-java minibuf-eldef gdb-mi flymake debug tramp-smb cus-edit erc-match org-agenda gnus-msg sql smerge-mode allout apropos reftex-vars verilog-mode semantic/complete nnmail compile org emacs-lock org-datetree man) ("24.4" ob-core bibtex em-term mml2015 tramp-cache gdb-mi message epa recentf gnus-start f90 tramp-adb strokes calc timeclock man info autorevert imenu idlwave sql org-gnus term ede/linux tramp-smb cookie1 org-protocol flymake-proc dired ansi-color tramp-sh mm-util cfengine saveplace vhdl-mode org-archive sh-script rlogin hi-lock org-clock nnimap sieve-manage gnus-art ox-beamer verilog-mode js rmail flymake org-src apropos info-xref type-break ob-ruby m4-mode bookmark flyspell log-edit ox-texinfo unrmail org-attach smie gnus mml-smime ob-ocaml gnutls reftex-vars org-mobile pop3 shr pcmpl-x desktop ob-ditaa quickurl python eww org gnus-sum compare-w ob-lilypond ox-man ob-python org-faces icomplete vc-svn ox-html remember calendar ox tramp octave doc-view org-agenda ox-odt ox-latex elec-pair package find-file ido ruby-mode ox-ascii) ("24.5" flyspell vc-hg erc-stamp erc mml2015) ("25.1" checkdoc js rcirc sh-script info vc-cvs url-tramp arc-mode em-term sgml-mode message vhdl-mode sql mml-sec ldap filecache vc-svn gnus-sum newst-reader vc gud autoinsert gnus-art rmailmm newst-treeview hideif find-func mm-decode cl-indent vc-hg eudc-vars gnus-fun gnus-registry calendar epg-config ls-lisp erc nsm gdb-mi erc-desktop-notifications url-handlers python check-declare xt-mouse whitespace compare-w tildify vc-mtn net-utils epa vc-bzr rect eww paren tramp-adb diff-mode shr verilog-mode tex-mode icalendar browse-url vc-git package vc-annotate) ("25.2" tramp-sh ffap) ("26.1" org-timer man quickurl ob-scheme enriched org-faces css-mode bytecomp package ob-exp ob-vala flyspell debug epa sql battery term mhtml-mode cpp dns-mode checkdoc browse-url ibuffer org-colview ox-md grep perl-mode icomplete executable gdb-mi tex-mode ibuf-ext dired org-bibtex dunnet ox-odt bibtex sieve-manage ox-texinfo erc tramp-sh comint wdired ox-beamer tls org-attach tramp message org-duration org-src python ediff-init mailcap add-log gnus-mh ob-lua ob-clojure ob-core ange-ftp shr org-clock ruby-mode org-table ox-ascii display-line-numbers image-dired org-bbdb ob-lisp ox-html net-utils org gnus-art vc-git cc-vars gnus-cloud ox flymake url-vars dired-x tramp-gvfs ob-J ox-latex edebug vc-hg ox-publish js org-agenda) ("27.1" flymake-proc grep comint server cus-edit footnote remember dired-aux))
